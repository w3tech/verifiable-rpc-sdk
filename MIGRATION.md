...
the placeholder numeric chain id. Their move to real string ids (TON global id
`"-239"`; Stellar network id = sha256 of the mainnet passphrase, a 64-char hex
string) requires a sidecar ≥ 0.5.0 redeploy per node and is
