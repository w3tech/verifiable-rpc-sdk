...
import { fetchAttestation } from "../src/index.ts";
import { PINNED_COMPOSE_HASH, URL, assert, header, kv } from "./shared.ts";
...
assert(
	composeEvent !== undefined,
	"no compose-hash event found in event_log",
);
assert(
