...
import { DecodeFailedError, UnsupportedEncodingError } from "../src/errors";
...
describe("decodeBody", () => {
  ...
  test("unknownTokenThrowsUnsupportedEncodingCarryingTheToken", async () => {
    await expect(decodeBody(ORIGINAL, "snappy", CAP)).rejects.toThrow(UnsupportedEncodingError);
